...
//	
//	/* Ce fonction est pour vÃ©rifier que si le module GPS est bien allumÃÂ© 
//	 * 
//	 */
//	
...
//        }
//
//        Toast.makeText(context, "GPS est ÃÂ©teint !", Toast.LENGTH_SHORT).show();
//        Intent intent = new Intent(Settings.ACTION_SECURITY_SETTINGS);
//        context.startActivityForResult(intent,CODE_ACTIVITY_GPS_VERIFICATION); //Ã¦Â­Â¤Ã¤Â¸ÂºÃ¨Â®Â¾Ã§Â½Â®Ã¥Â®ÅÃ¦Ëï¿½Ã¥ï¿½Å½Ã¨Â¿âÃ¥âºÅ¾Ã¥ËÂ°Ã¨Å½Â·Ã¥ï¿½âÃ§â¢ÅÃ©ï¿½Â¢
//       
//    }
//	
//	
//	/*
//	 * c'est pour calculer les stations proches de l'utilisateur dans un rayon dÃÂ©fini
//	 */
//	
